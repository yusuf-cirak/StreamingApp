...
public readonly record struct UserOperationClaimErrors
{
    ...
    public static readonly Error FailedToCreateUserOperationClaimForValue =
        Error.Create("UserOperationClaims.FailedToCreate",
            "Failed to create user operation claim for value");

    public static readonly Error FailedToDeleteUserOperationClaimForValue =
        Error.Create("UserOperationClaims.FailedToDelete",
            "Failed to create user operation claim for value");
